...
[mike01@master1 ~]$ hadoop fs -mkdir -p /user/mike01/project/yelp/pigOutput


REGISTER '/home/mike01/piggybank.jar'; 
REGISTER '/home/mike01/elephant-bird-hadoop-compat-4.14-RC2.jar';
REGISTER '/home/mike01/elephant-bird-core-4.14-RC2.jar';
REGISTER '/home/mike01/elephant-bird-pig-4.14-RC2.jar';
REGISTER '/home/mike01/json-simple-1.1.1.jar';

json_business_row_jsonLoader = LOAD '/user/mike01/project/yelp/businessExternal/yelp_training_set_business.json' USING com.twitter.elephantbird.pig.load.JsonLoader('-nestedLoad') AS (json:map []);
...
STORE json_business_row INTO 'hdfs:///user/mike01/project/yelp/pigOutput/json_business_table' USING PigStorage('\u0001');
